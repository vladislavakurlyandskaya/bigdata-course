...
with DAG(dag_id=DAG_ID,
    ...
    load_instance_raw_task = PythonOperator(dag=dag,
                                            task_id=f"{DAG_ID}.RAW.{instance_table_name}",
                                            python_callable=load_csv_pandas,
                                            op_kwargs={
                                                "table_name": instance_table_name,
                                                "schema": "raw",
                                                "conn_id": "raw_postgres"
                                            }
                                            )
    ...
    start_task >> create_schema_raw >> create_schema_datamart >> [load_customer_raw_task,
                                                                  load_payments_raw_task,
                                                                  load_instance_raw_task,
                                                                  load_product_raw_task,
                                                                  load_costed_event_raw_task] >> customer_totals_datamart_task >> end_task
